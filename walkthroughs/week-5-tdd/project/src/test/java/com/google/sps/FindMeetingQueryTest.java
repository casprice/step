...
public final class FindMeetingQueryTest {
  ...
  public void ignoreUnavailableOptionalAttendees() {
    // Have two mandatory people with different events, and an optional person with an 
    // all-day event. We should only see the time slots for the mandatory people.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void everyAttendeeIsConsideredIncludingOptional() {
    // Have two mandatory attendees and one optional attendee, all with different event
    // times. Only the early and late parts of the day should be returned 
    //
    // Events  :       |--A--||--C--||--B--|
    // Day     : |-------------------------------|
    // Options : |--1--|                   |--2--|
  ...
  public void justEnoughRoomWithoutOptionalAttendees() {
    // Have only one available time slot for a mandatory attendee, and an optional attendee who
    // is busy during that time slot. Should ignore the optional attendee and still return that
    // time slot.
    //
    // Events  : |--A--||-B-|   |----A----|
    // Day     : |------------------------|
  ...
  public void everyOptionalAttendeeIsConsidered() {
    // Have only optional people with different events. We should see the gaps in their
    // schedules.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
